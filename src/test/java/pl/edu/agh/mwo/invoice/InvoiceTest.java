...
public class InvoiceTest {
	...
	public void testEmptyInvoiceHasEmptySubtotal() {
		Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getNePrice()));
	}
	...
	public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
		...
		Assert.assertThat(invoice.getGrossPrice(), Matchers.comparesEqualTo(invoice.getNePrice()));
	}
	...
	public void testInvoiceHasProperSubtotalForManyProducts() {
		...
		Assert.assertThat(new BigDecimal("310"), Matchers.comparesEqualTo(invoice.getNePrice()));
	}
	...
	public void testInvoiceHasPropoerSubtotalWithQuantityMoreThanOne() {
		...
		Assert.assertThat(new BigDecimal("50"), Matchers.comparesEqualTo(invoice.getNePrice()));
	}
